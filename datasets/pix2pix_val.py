...
fileNamesIP = glob.glob('testDCPDNIP\\*h5')
#fileNamesIP = fileNamesIP[40:]
rootDCPDNIP = 'testDCPDNIP\\'
...
class pix2pix_val(data.Dataset):
  ...
  def __getitem__(self, index):
    ...
    nameToRead = fileNamesIP[index]
    file_name=self.root+'/'+nameToRead[len(rootDCPDNIP):-3]+'.h5'
